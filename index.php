...
<html lang="en">
  <head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="https://upload.wikimedia.org/wikipedia/commons/d/d8/Pizza_slice_icon.png" type="image/x-icon">
...
//Is there any way we could have it on menu page? Since we mentioned we'd have it there show me in ui
      ...
      <div class="mu-top-slider">
        ...
        <div class="mu-top-slider-single">
          ...
          <div class="mu-top-slider-content">
            ...
            <a href="#" class="mu-readmore-btn">ORDER ONLINE</a>
          </div>
          <!-- / Top slider content -->
        </div>
        <!-- / Top slider single slide -->    
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mu-about-us-left">
                 <p>It all started in 1972, when owner Judy Waller opened her first U.S. Pizza Company in a burned out clock shop in Levy, AR. Armed with 
				 a unique recipe for thin crust pizza and an old fashioned stone hearth oven, U.S. Pizza embarked on a quarter-of-a-century journey 
				 that has done everything but dwindle.That first store grossed only about $1,000 per week, but ten other U.S. Pizza Company locations
				 have opened since. In addition to the chain of U.S. Pizza Companies, in 1981, Judy opened Hillcrest Liquor Store on Kavanaugh Boulevard 
				 in Little Rock.Since we opened our first store in 1972, we’ve been making our thin crust pizza from scratch when you order it. And we 
				 still use stone hearth ovens. That’s one of the reasons our unique pizzas are worth the wait!We pride ourselves in offering you the 
				 very best pizza, salads and sandwiches, and we value your patronage. With more than 44 years of experience under our belts, 
			     we understand how to best serve our customers through tried and true service principles. Instead of following trends, we set them.
			     We create food we’re proud to serve and deliver it fast, with a smile. If you’re looking for a reason not to cook, need a place to
				 watch the game with friends, or spending time with family, we’ve made sure there’s something for everybody.</p>                              
            ...
            <div class="mu-restaurant-menu-content">
              <ul class="nav nav-tabs mu-restaurant-menu">
                ...
                foreach($categories as $key=>$value){
                  echo '<li'.$isActive.'><a href="#category-'.$value['c_id'].'" data-toggle="tab">'.$value['c_name'].'</a></li>';
                  $isActive = '';
                }
                ?>
              </ul>
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane fade in <?= $key == 0 ? 'active' : '' ?>" id="category-<?= $value['c_id']?>">
                  <div class="mu-tab-content-area">
                    <div class="row">
                     <?php
                        $pizzas = $session->getPizzasForCategory($value['c_id']);
                            ...
                            echo '<li>
                             <div class="media">
                               <div class="media-left">
                                 <a href="#">
                                   <img class="media-object" src="includes/pizza_images/'.$value['p_photo'].'"" alt="img">
                                 </a>
                               </div>
                               <div class="media-body">
                                 <h4 class="media-heading"><a href="#">'.$value['p_name'].'</a></h4>
                             ';
 // echo $pizzaId;
                                $prices = $session->getPizzaPrices($pizzaId);
                                foreach($prices as $key=>$value){  
                                 ...
                                 $ingredientsRaw = $session->getPizzaIngredients($pizzaId);
                    ...
                    <div class="mu-single-gallery-item">
	                    ...
	                    <div class="mu-single-gallery-info">
	                       ...
	                       <div class="portfolio-detail">
			                    ...
			                    <img src="assets/img/gallery/big/1.jpg" alt="img-1" />
...
<!--               <a href="blog-archive.html" class="mu-browsmore-btn">BROWS MORE</a>
 -->              <!-- End brows more btn -->
                  ...
                  <div class="mu-contact-left">
                    <form class="mu-contact-form" action="includes/process.php" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="message" cols="30" rows="10" placeholder="Type Your Message" name="message" required></textarea>
                      </div>
                ...
                <div class="col-md-6">
                  <div class="mu-contact-right">
                    <div class="mu-contact-widget">
                      ...
                      <p>We always aim to provide a great experience, but if we didn’t get it right this time, then we are here to help. We love hearing from our guest and neighbors.
					  Please use this form to let us know what's on your mind. We'll get back to you as soon as possible.</p>
                      <address>
  ...
  <!-- Start Map section -->
  <section id="mu-map">
     <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2934.6588197205488!2d21.150674515128237!3d42.6473923791686!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x13549e8d5d607f25%3A0xa31dd05b21bd09de!2sUniversity+for+Business+and+Technology!5e0!3m2!1sen!2s!4v1479229117993" width="100%" height="100%" frameborder="0" allowfullscreen></iframe>
  </section>
  <!-- End Map section -->
      ...
      <div class="row">
        ...
        <div class="mu-footer-area">
          ...
          <div class="mu-footer-copyright">
            <p>Designed by <a rel="nofollow" href="http://www.markups.io/">UBT students</a></p>
          </div>         
        </div>
      </div>
      </div>
